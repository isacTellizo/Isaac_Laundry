                ...
                <div class="modal-body p-24">
                    <div class="row">
                        ...
                        <div class="col-6 mb-6">
                            ...
                            <input type="text" class="form-control" id="name" wire:model='phone' placeholder="Enter Phone Number">
                            @error('phone')
                            <span class="text-red-500 text-xs">{{$message}}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-6 mb-6">
                            ...
                            <input type="number" class="form-control" id="name" wire:model='tax_number' placeholder="Enter Tax Number">
                            @error('tax_number')
                            <span class="text-red-500 text-xs">{{$message}}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-12 mb-6">
                            ...
                            <textarea class="form-control !resize-none" rows="3" id="description" wire:model="address" placeholder="Enter Address"></textarea>
                        </div>
